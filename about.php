...
<main id="primary" class="maxWidth about_page">
    ...
    <div class="content_container">
        ...
        <section class="about_page_treatment_list_section">
            <div class="about_page_treatment_list_container" style="<?= !empty(get_field('about_page_treatment_list_background_image')) ? 'background:url(' . get_field('about_page_treatment_list_background_image')['url'] .  ');' : '' ?>">
